...
const solutions = [
  {
    title: 'Aulas H├¡bridas',
    desc: 'Tecnolog├¡a interactiva para ense├▒ar de manera presencial y remota al mismo tiempo.',
  ...
  },
  {
    ...
    desc: 'Espacios de innovaci├│n con rob├│tica, impresi├│n 3D y recursos para ciencia y matem├íticas.',
...
const differentiators = [
  { icon: ShieldCheck, title: 'Distribuidores Oficiales', desc: '├Ünicos representantes autorizados de Mimio, eBeam, Practi-Man y THScreen en Argentina.' },
  { icon: Users, title: 'Soporte Pedag├│gico Real', desc: 'No vendemos cajas: acompa├▒amos con capacitaci├│n in-situ y seguimiento continuo.' },
  { icon: Cpu, title: 'Ecosistema Integrado', desc: 'Hardware + Software + Gamificaci├│n (TOMi) + Capacitaci├│n en un ├║nico proveedor.' },
  { icon: Star, title: '15 A├▒os de Trayectoria', desc: 'M├ís de 2.000 instituciones transformaron sus aulas en Argentina, Paraguay y Uruguay.' },
];
...
const partners = [
  ...
  { img: '/assets/pantallastactiles.png', name: 'Pantallas T├íctiles', desc: 'Cat├ílogo de pantallas t├íctiles interactivas.', href: 'https://pantallastactiles.com.ar/', color: '#F97316', bg: '#FFF7ED' },
...
/* ÔöÇÔöÇÔöÇ Brands Marquee ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
export default function LandingView() {
  return (
    <>
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ HERO ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-6"
                ...
                M├ís de 15 a├▒os transformando aulas
              </span>
              ...
              <p className="text-base mb-10 max-w-lg leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>
                ...
                y simuladores m├®dicos en Argentina, Paraguay y Uruguay.
              </p>

              <div className="flex flex-wrap gap-3">
                <Link href="/contacto" className="btn-lime flex items-center gap-2">
                  Cont├íctanos <ArrowRight className="w-4 h-4" />
                </Link>
      ...
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ SOLUCIONES CARDS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
        ...
        <div className="max-w-7xl mx-auto">
          <Animate type="fade-up">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Soluciones para tu Instituci├│n</h2>
              <p className="text-gray-500 text-sm mt-3 max-w-lg mx-auto">
                Desde consultor├¡a hasta capacitaci├│n y soporte t├®cnico ÔÇö acompa├▒amos todo el ciclo.
              </p>
            </div>
          </Animate>
                ...
                <Link href={sol.href} className="group block overflow-hidden rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" style={{ border: '1px solid #e5e7eb' }}>
                  ...
                  <div className="p-5 bg-white">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-sm font-semibold transition-all group-hover:gap-2.5" style={{ color: 'var(--brand-navy)' }}>
                      Conocer soluci├│n <ArrowRight className="w-4 h-4" />
                    </span>
                  </div>
                </Link>
              </Animate>
      ...
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ BRANDS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <BrandsMarquee />

      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ VIDEO ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <section className="py-16 px-6" style={{ background: '#f7f8fc' }}>
        <div className="max-w-5xl mx-auto">
          <Animate type="zoom-in">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-gray-900">Mir├í c├│mo transformamos el aula</h2>
            </div>
      ...
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ PRODUCTS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <ProductsCarousel />

      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ CLIENTES ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <Animate type="fade-up">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Instituciones que conf├¡an en nosotros</h2>
            <p className="text-gray-500 text-sm max-w-xl mx-auto mb-10">
              M├ís de 500 instituciones eligieron La Clase Digital para transformar sus aulas.
            </p>
          </Animate>
      ...
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ PLATAFORMAS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <section className="py-16 px-6" style={{ background: '#f7f8fc' }}>
        <div className="max-w-5xl mx-auto">
          <Animate type="fade-up">
          ...
          <Animate type="zoom-in" delay={100}>
            <Link href="https://tomi.digital/es" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-sm text-gray-500">Gamificaci├│n educativa l├¡der en Latinoam├®rica. Juegos interactivos, tableros y contenido curricular integrado.</p>
              </div>
              <span className="shrink-0 px-5 py-2.5 rounded-lg text-sm font-bold text-white animate-glow-pulse"
                style={{ background: 'linear-gradient(135deg, #2563EB, #7C3AED)' }}>
                Ir a TOMi Digital ÔåÆ
              </span>
            </Link>
          </Animate>
      ...
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ POR QU├ë ELEGIRNOS ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      <section className="py-20 px-6" style={{ background: 'var(--brand-navy)' }}>
        <div className="max-w-6xl mx-auto">
          <Animate type="fade-up">
            <div className="text-center mb-14">
              <p className="text-[11px] font-bold uppercase tracking-widest mb-3" style={{ color: 'var(--brand-cyan)' }}>Por qu├® elegirnos</p>
              <h2 className="text-3xl font-bold text-white">No somos un proveedor m├ís</h2>
              <p className="mt-3 max-w-xl mx-auto text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>
                El ├║nico ecosistema educativo que combina hardware oficial, software y acompa├▒amiento pedag├│gico.
              </p>
            </div>
          </Animate>
