        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center shrink-0">
              <img src="/lcd_logo.png" alt="La Clase Digital" width={140} height={40} className="brightness-0 invert" />
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-1">
              {navItems.map((item) => (
                <div
                  ...
                  onMouseEnter={() => (item.subItems || item.subGroups) && openDropdown(item.label)}
                ...
                >
                  ...
                  {item.subGroups && activeDropdown === item.label && (
                    <div className="absolute top-full left-0 mt-1 rounded-2xl shadow-2xl overflow-hidden"
