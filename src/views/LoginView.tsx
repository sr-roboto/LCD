        ...
        <Animate type="zoom-in">
          <div className="bg-white/10 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-2xl border border-white/20">
            <div className="text-center mb-10">
              <h1 className="text-3xl font-extrabold text-white tracking-tight mb-2">Iniciar Sesión</h1>
              <p className="text-white/50 text-sm font-medium">Bienvenido de vuelta a La Clase Digital</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {loading ? "Iniciando..." : "Entrar a la plataforma"}
            ...
            <p className="mt-10 text-center text-sm text-white/40 font-medium">
              ...
              <Link href="/registro" className="text-[#00D4F5] font-black hover:underline transition-colors">
                Regístrate gratis
              </Link>
            </p>
          </div>
