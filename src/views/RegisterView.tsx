        ...
        <Animate type="fade-up">
          <div className="card-dark p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--foreground-muted)] text-sm">Unite a La Clase Digital</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <User className="w-5 h-5 text-[var(--foreground-subtle)] absolute left-4 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                    required
                    value={name}
            ...
            <p className="mt-8 text-center text-sm text-[var(--foreground-muted)]">
              ...
              <Link href="/login" className="text-[var(--brand-emerald)] font-semibold hover:underline">
                Inicia sesion aqui
              </Link>
            </p>
          </div>
