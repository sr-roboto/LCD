...
const differentiators = [
  ...
  { icon: Users, title: "Soporte Pedagógico Real", desc: "No vendemos cajas: acompañamos la implementación con capacitación in-situ y seguimiento." },
      ...
      <section className="relative page-hero-gradient pt-20 pb-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
            <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }} className="block">
              Transformamos la{" "}
              <span style={{ color: "var(--brand-blue)" }}>educación</span>
            </motion.span>
            <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28, duration: 0.5 }} className="block">
              con <span style={{ color: "var(--brand-green)" }}>tecnología.</span>
            </motion.span>
          </h1>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm max-w-xl mx-auto mb-10">
            Más de 500 instituciones de Argentina, Paraguay y Uruguay eligieron
            La Clase Digital para transformar sus aulas.
          </p>
          </Animate>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <Animate type="zoom-in" delay={100}>
            ...
            >
              ...
              <div className="flex-1 text-center md:text-left">
                <span className="text-[10px] font-bold uppercase tracking-widest text-purple-600">Plataforma educativa</span>
                <h3 className="text-xl font-bold text-gray-900 mb-1">TOMi Digital</h3>
                <p className="text-sm text-gray-500">La plataforma de gamificación educativa líder en Latinoamérica. Juegos interactivos, tableros y contenido curricular integrados con nuestros dispositivos.</p>
              </div>
              <span className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white animate-glow-pulse"
          ...
          <Animate type="fade-up" delay={200}>
            <div className="mb-3">
              <span className="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full text-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <Animate key={s.name} type="fade-up" delay={([300, 400, 500] as const)[i]}>
                <Link
                  href={s.href}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="font-bold text-sm group-hover:underline" style={{ color: s.color }}>{s.name}</p>
          ...
          <Animate type="fade-up">
            <div className="text-center mb-14">
              ...
              <p className="text-gray-500 mt-3 max-w-xl mx-auto text-sm">
                El único ecosistema educativo que combina hardware oficial, software de gamificación y
                acompañamiento pedagógico en un solo lugar.
              </p>
            </div>
          </Animate>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {differentiators.map((d, i) => (
              <Animate key={d.title} type="fade-up" delay={([0, 200, 300, 400] as const)[i]}>
              <div
                className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md hover:border-blue-200 transition-all group"
              >
                <div
                ...
                >
                  <d.icon className="w-5 h-5 transition-colors" style={{ color: "var(--brand-blue)" }} />
                </div>
